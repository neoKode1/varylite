-- Database Optimization Scripts for vARY Ai
-- Run these in your Supabase SQL editor to improve performance

-- 1. Create optimized indexes for frequently queried columns
-- Note: Run these commands individually outside of transaction blocks for CONCURRENTLY
-- For Supabase, use regular CREATE INDEX commands
...
-- 9. Create scheduled jobs (if using pg_cron extension)
...
-- 10. Create performance monitoring views
