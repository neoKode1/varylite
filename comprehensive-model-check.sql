...
-- These are the models I found in the codebase:

-- Image Models (from generate/page.tsx GenerationMode type)
SELECT 
    CASE 
...
-- Video Models (from generate/page.tsx GenerationMode type)
SELECT 
    CASE 
...
SELECT 
    'MISSING MODELS' as status,
    am.model_name,
    'NOT FOUND IN DATABASE' as reason
FROM app_models am
